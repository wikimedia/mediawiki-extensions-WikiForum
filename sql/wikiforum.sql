...
CREATE TABLE IF NOT EXISTS /*_*/wikiforum_forums (
	...
	wff_last_post_actor bigint unsigned NOT NULL,
	...
	wff_added_actor bigint unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS /*_*/wikiforum_threads (
	...
	wft_closed_actor bigint unsigned NOT NULL,
	...
	wft_last_post_actor bigint unsigned NOT NULL,
